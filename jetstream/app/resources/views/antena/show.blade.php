        ...
        <div class="card card-info card-outline">
            <div class="card-body box-profile card-responsive-sm">
                ...
                <form name="frmDelete" action="{{ route('antena.destroy', $antena->id) }}" method="post" onsubmit="return confirm('Confirma a exclusão da antena?');">
                    ...
                    <a style=' color:white;' href="{{ route('antena.edit', $antena->id) }}"> <input class="btn btn-info" type="button" value="Editar"></a>
                   ...
                   <?php  } ?>
                    ...
                    <a style=' color:white;' href="{{ route('antena.index') }}"> <input class="btn btn-info" type="button" value="Voltar"></a>
