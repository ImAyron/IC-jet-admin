...
const char* ssid = "Rep.KALANGO";
const char* password = "porekada";
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
...
void loop() {
  ...
  if (readsuccess) {
    ...
    http.begin(client, "http://192.168.0.12:8000/api/operation");  //Specify request destination
    http.addHeader("Content-Type", "application/x-www-form-urlencoded"); //Specify content-type header
    int httpCode = http.POST("operations=" + postData+"&antena=lavanderia"+"&tipo="+tipo); //Send the request
